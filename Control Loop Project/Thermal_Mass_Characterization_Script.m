...
cooldown_1_end_index = find_index_from_time(cooldown_1_end_time,times);
...
T_motor_initial_ramp = new_motor_temps(ramp_1_start_index);
...
T_motor_initial_cooldown = new_motor_temps(cooldown_1_start_index);
T_motor_final_cooldown = new_motor_temps(cooldown_1_end_index);
T_mc_initial_cooldown = new_mc_temps(cooldown_1_start_index);
T_mc_final_cooldown = new_mc_temps(cooldown_1_end_index);
...
function k = k_cooldown(q_time,q_out,C_motor,T_motor_initial,T_motor_final,T_mc_initial,T_mc_final)
    T_m = T_motor_final-T_motor_initial;
    T_mc = T_mc_final-T_mc_initial;

...
strain_data = []
csv_files = [
r"C:\Users\sean8\Desktop\frucd code\Blue Max Endurance\EnduranceBlueMax_parsed - EnduranceBlueMax_parsed.csv"]
limit = 32768
...
#     write.writerow(MC_fields)
#     write.writerows(MC_temps3)
# writepath = r"C:\Users\sean8\Desktop\frucd code\2024-04-27\Parsed\Chris_Acceleration_RPM.csv"
# with open(writepath,'w',newline='') as csv_file:
#     write = csv.writer(csv_file)
#     write.writerow(RPM_fields)
#     write.writerows(RPM_data)
# writepath = r"C:\Users\sean8\Desktop\frucd code\2024-04-27\Parsed\Chris_Acceleration_Torque.csv"
# with open(writepath,'w',newline='') as csv_file:
#     write = csv.writer(csv_file)
...
#         row = []
#         i += 1
writepath = r"C:\Users\sean8\Desktop\frucd code\Blue Max Endurance\Water_Air_Temps.csv"
with open(writepath,'w',newline='') as csv_file:
    write = csv.writer(csv_file)
    write.writerow(Water_Air_temps_fields)
    write.writerows(temp_data)
writepath = r"C:\Users\sean8\Desktop\frucd code\Blue Max Endurance\Motor_Temps.csv"
with open(writepath,'w',newline='') as csv_file:
    write = csv.writer(csv_file)
    write.writerow(Motor_fields)
    write.writerows(Motor_temps)
    writepath = r"C:\Users\sean8\Desktop\frucd code\Blue Max Endurance\MC_Temps.csv"
with open(writepath,'w',newline='') as csv_file:
    write = csv.writer(csv_file)
    write.writerow(MC_fields)
    write.writerows(MC_temps3)
